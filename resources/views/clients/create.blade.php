                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('clients.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="social_reason" type="text" class="form-control @error('social_reason') is-invalid @enderror" name="social_reason" value="{{ old('social_reason') }}"  autocomplete="social_reason" autofocus>
